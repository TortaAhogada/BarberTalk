<?php
    ...
    $consulta="select t.nickname ,t.correo, t.num_telefono from trabajador t where t.nickname ='$usuario'";
    ...
    <!-- Aqui va lo del perfil del dueño -->
     <div class="container">
        <div class="Complicated">
             <br>
             <br>
             <h3 style="height: 0;">Dueño: </h3>
             <input class="nombredueño" type="text" name="nombre" id="nombre" placeholder="<?php echo $row['nickname'] ?>" readonly>
             <img class="imagenbarbero" src="PerfilDueño/img/usuario.png" width="150" height="150" style=" border: 1px solid black;" alt="no se encontro">
             ...
             <div class="containerDatos">
                <div class="ComplicatedDatos">
                     ...
                     <input style="width: 23%;" class="correo" type="email" name="correo" id="correo" placeholder="<?php echo $row['correo'] ?>" readonly>
                     
                     <p class="telefonoT">Telefono</p>
                     <input style="width: 23%;" class="telefono" type="telefono" name="telefono" id="telefono" placeholder="<?php echo $row['num_telefono'] ?>" readonly>
                     ...
                     <div class="botonI"> <p><a href="ConfiguracionD.php"><input  class="boton" type="button" value="Configuración"href="PerfilDueño.php"></a></p></div> 
                     <div class="botonR"> <p><a href="Tabla_Dueño.php"><input  class="botonr" type="button" value="Registro Citas"href="PerfilDueño.php"></a></p></div> 
                     <div class="botonP"> <p><a href="TablaPDueño.php"><input  class="botonp" type="button" value="Detalles de Barberos"href="PerfilDueño.php"></a></p></div> 
                     <div class="botonH"> <p><a href="TablaHorario.php"><input  class="botonh" type="button" value="Horarios de Barberos"href="PerfilDueño.php"></a></p></div> 
